    ...
    <div className="min-h-screen bg-surface flex">
      ...
      {msgToast && (
        <div
          ...
          onClick={() => {
            setMsgToast(null)
            navigate(user?.role === 'brand' ? '/brand/collaborations' : '/creator/collaborations')
          }}
        >
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs font-bold text-purple-200">{msgToast.senderName}</p>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 bg-white border-b border-border px-4 sm:px-6 py-4 flex items-center justify-between">
          <button onClick={() => setSidebarOpen(true)} className="lg:hidden p-2 rounded-lg text-muted hover:bg-surface">
            ☰
          </button>
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <div className="flex items-center gap-2 pl-1">
              ...
              <div className="hidden sm:block min-w-0">
                <p className="text-xs font-bold text-secondary truncate max-w-[120px]">{user?.fullName}</p>
                <p className="text-xs text-muted capitalize">{user?.role}</p>
              </div>
            </div>
          </div>
