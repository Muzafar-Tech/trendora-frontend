    ...
    <>
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="bg-primary-light rounded-xl p-4 text-center">
                ...
                <p className="text-xs text-muted mt-1">
                  Creator will receive PKR{" "}
                  {uploadModal.creatorAmount?.toLocaleString()} after 10%
                  commission
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-border">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    {
                      label: "Amount",
                      value: `PKR ${uploadModal.totalAmount?.toLocaleString()}`,
                    },
                  ].map((item, i) => (
      ...
      <div className="mb-6">
        ...
        <p className="text-muted text-sm mt-1">
          Track all your campaign payments.
        </p>
      </div>
          ...
          {[
            {
              ...
              desc: "Accept a creator application",
            },
            {
              step: "2",
              title: "Pay Trendora",
              desc: "Send payment via JazzCash & upload screenshot",
            },
            {
              step: "3",
              title: "Admin Verifies",
              desc: "Admin verifies within 24 hours & collaboration activates",
            },
            {
              step: "4",
              title: "Work & Release",
              desc: "Approve work → creator gets paid automatically",
            },
          ].map((s) => (
      ...
      <div className="bg-card rounded-2xl border border-border shadow-card p-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted text-sm mt-1">
              Accept a creator to see payment here.
            </p>
          </div>
        ) : (
          <div className="space-y-3">
            {payments.map((p) => (
              <div
                key={p._id}
                className="bg-surface rounded-xl p-4 border border-border hover:border-primary transition-all"
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <span
                      className={`text-xs font-semibold px-2.5 py-1 rounded-full whitespace-nowrap ${statusColors[p.status]}`}
                    >
